          ...
          {result.hasQuestions ? (
            ...
            <div className="space-y-8">
              <div className="bg-card p-6 rounded-lg border">
                ...
                <p className="text-muted-foreground whitespace-pre-wrap ml-8">{result.summary}</p>
              </div>
